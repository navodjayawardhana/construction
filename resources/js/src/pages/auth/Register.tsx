        ...
        <div className="flex min-h-screen items-center justify-center bg-[url('/assets/images/map.svg')] bg-cover bg-center dark:bg-[url('/assets/images/map-dark.svg')]">
            <div className="panel m-6 w-full max-w-lg sm:w-[480px]">
                <div className="flex flex-col items-center mb-10">
                    ...
                    <h2 className="text-2xl font-bold text-construction">Create Account</h2>
                ...
                <form className="space-y-5" onSubmit={handleSubmit}>
                    <div>
                        ...
                        <input id="name" type="text" className="form-input" placeholder="Enter name" value={name} onChange={(e) => setName(e.target.value)} required />
                    </div>
                    <div>
                    ...
                    <div>
                        ...
                        <input id="password" type="password" className="form-input" placeholder="Enter password" value={password} onChange={(e) => setPassword(e.target.value)} required />
                    </div>
                    <div>
                        <label htmlFor="password_confirmation" className="dark:text-white">Confirm Password</label>
                        <input id="password_confirmation" type="password" className="form-input" placeholder="Confirm password" value={passwordConfirmation} onChange={(e) => setPasswordConfirmation(e.target.value)} required />
                    </div>
                ...
                <p className="text-center mt-6 text-sm">
                    ...
                    <Link to="/login" className="font-bold text-construction hover:underline">
                        Sign In
                    </Link>
                </p>
            </div>
